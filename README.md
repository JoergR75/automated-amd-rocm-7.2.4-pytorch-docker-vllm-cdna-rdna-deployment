...
```bash
wget https://raw.githubusercontent.com/JoergR75/rocm-7.2.4-pytorch-docker-cdna-rdna-automated-deployment/refs/heads/main/script_module_ROCm_724_Ubuntu_22.04-24.04_pytorch_server.sh
```
