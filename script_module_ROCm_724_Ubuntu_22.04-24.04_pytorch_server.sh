...
# ================================================================================================================
# Description:
# This script automates the installation of AMD ROCm 7.2.4, PyTorch 2.12 (Stable), Transformers, and Docker
...
install_jammy() {
    ...
    sudo DEBIAN_FRONTEND=noninteractive apt-get install -yq ./amdgpu-install_7.2.4.70204-1_all.deb --allow-downgrades

    # Installing multiple use cases including ROCm 7.2.4, OCL and HIP SDK

    print '\n 📦 Installing ROCm 7.2.4 stack + OCL environment ...\n'
    ...
    print '\n 📦 Installing PyTorch 2.12 (Stable), Transformers environment ...\n'
...
print ' ✅ Finished AMD ROCm 7.2.4 stack + OCL + PyTorch 2.12 (Stable) + Transformers environment installation and setup.\n'
...
printf "  RDNA4 → sudo docker pull vllm/vllm-openai-rocm:v0.22.0\n"
...
printf "  sudo docker run -it --device=/dev/kfd --device=/dev/dri \\
    --security-opt seccomp=unconfined --group-add video vllm/vllm-openai-rocm:v0.22.0\n"

printf "\nThe container will run using the image 'vllm/vllm-openai-rocm:v0.22.0', with flags enabling AMD GPU access via ROCm.\n\n"
